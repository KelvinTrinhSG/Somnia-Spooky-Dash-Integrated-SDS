...
namespace GhostFrenzyGame
{
	...
	/// </summary>
	public class GFGLoadLevel : MonoBehaviour
	{
		...
		IEnumerator ExecuteLoadLevel()
		{
			...
			PlayerDataManager.Instance.ResetTimer();
			Debug.Log("Reset Timer");
			Debug.Log(PlayerDataManager.Instance.startTime);
			Debug.Log(PlayerDataManager.Instance.endTime);
			Debug.Log(PlayerDataManager.Instance.duration);

			Debug.Log("Start Timer");
			PlayerDataManager.Instance.StartTimer();
			Debug.Log(PlayerDataManager.Instance.startTime);
