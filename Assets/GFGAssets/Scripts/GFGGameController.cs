...
namespace GhostFrenzyGame
{
	...
	/// </summary>
	public class GFGGameController:MonoBehaviour 
	{
		[Header("<Game Area>")]
		...
		public LeaderboardUploader1 LeaderboardUploader1object;
...
//CALCULATING SPAWN CHANCES
		...
		IEnumerator GameOver(float delay)
		{
			...
			if ( gameOverCanvas )    
			{
				...
				PlayerDataManager.Instance.StopTimer();
				Debug.Log(PlayerDataManager.Instance.endTime);
				Debug.Log(PlayerDataManager.Instance.duration);
				...
				{
					LeaderboardUploader1object.UploadScore(PlayerDataManager.Instance.walletAddress, finalScore,PlayerDataManager.Instance.duration);
